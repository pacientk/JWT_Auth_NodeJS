         ...
         <nav
            ...
            <Popover.Group className={'hidden lg:flex lg:gap-x-12'}>
               <Popover className={'relative'}>
                  <Popover.Button
                     className={
                        'flex items-center gap-x-1 text-sm font-normal leading-6 text-gray-900'
                     }>
                     Product
                     <ChevronDownIcon
               ...
               <Link href="#" className={'text-sm font-normal leading-6 text-gray-900'}>
                  Features
               </Link>
               <Link href="#" className={'text-sm font-normal leading-6 text-gray-900'}>
                  Marketplace
